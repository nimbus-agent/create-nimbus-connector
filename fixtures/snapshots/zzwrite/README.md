...
Nimbus MCP connector for Zzwrite. Indexes and provides context from Zzwrite to the Nimbus agent.
...
```bash
export ZZWRITE_CLIENT_ID=...
export ZZWRITE_CLIENT_SECRET=...
```
...
- [Zzwrite Connector Documentation](https://nimbus-agent.dev/user-guide/connectors/)
