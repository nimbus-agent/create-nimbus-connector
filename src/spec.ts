 ...
 *     there is a documented feature: it is what 7 of the 24 fixtures write, three of them the
 ...
 *     `tools[].path`, and this is not a rare case: `${` appears in a `tools[].path` in 21 of the
 *     24 fixtures, against 7 for `fetchHelper.base` (measured 2026-08-09 over `fixtures/*.spec.json`).
 ...
 *
 * Measured across the 24 fixtures: no guarded field carries a backtick, a block-comment
